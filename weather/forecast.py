...
# retrieve the forecast and print the output
def main(args):
	...
	try:
		output_json = requests.get('http://api.wunderground.com/api/'+config["weather_wunderground_api_key"]+'/forecast10day/q/'+query+'.json').text
